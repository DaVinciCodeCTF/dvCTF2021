...
void delete_quote()
{
    ...
    {
        free(book[choice - 1]);
        //Vuln ici, le pointeur est pas remis à null après être free, et book_ctr est décrémenté
        //Plus chiant si on rajoute les free des buffers content / title
        book_ctr--;
    }
}
...
/*
Le chall est solvable aussi avec la PIE en changeant qq détails, mais c'est plus dur.
La vuln est exploitable de plusieurs façons, notamment si le Docker utilise une vieille libc (le double free tcache peut marcher)
*/
